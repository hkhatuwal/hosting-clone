...
export default function VpsSmarterTools() {
    const [currentSlide, setCurrentSlide] = useState(0);

    const slides = [
        {
            image: "/assets/images/vps-control-panel.webp",
            title: "Intuitive Control Panel",
            description: "Provision, reboot, reinstall OS, and manage snapshots from a clean dashboard. Optional cPanel or CyberPanel for familiar web hosting workflows on your VPS.",
        },
        {
            image: "/assets/images/vps-ssh-terminal.webp",
            title: "SSH & Developer Tools",
            description: "Full root SSH access, Git deploy hooks, Docker-ready environments, and staging clones. Build, test, and ship with the tools your stack already uses.",
        },
        {
            image: "/assets/images/vps-snapshots.webp",
            title: "Snapshots & Automated Backups",
            description: "One-click snapshots before major changes. Scheduled backups stored off-server so you can restore files, databases, or the entire VPS in minutes.",
        }
    ];
                ...
                <div className="flex flex-col md:flex-row justify-between items-start mb-8 md:mb-12 gap-4">
                    <div className="max-w-2xl">
                        <h2 className="text-2xl md:text-4xl lg:text-5xl font-display font-semibold text-gray-900 mb-4 md:mb-6">
                            Powerful tools. Total control.
                        </h2>
                        <p className="text-base md:text-lg text-gray-700 leading-relaxed">
                            With Adlef VPS, you get dedicated resources, root access, and the
                            management tools to run production workloads with confidence.
                        </p>
                    </div>
